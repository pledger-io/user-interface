...
const TransactionList: FC<TransactionListProps> = ({ account, range }) => {
  ...
  return <>
    ...
    { hasTransactions && Object.keys(transactions).map(key => {
      ...
      return <div key={ key } className='flex flex-col gap-0.5 pb-1 text-[0.9em]'>
        <div
          className='flex gap-2 items-center border-b py-0.5 mb-1 px-2 md:rounded-lg bg-blue-300/10 md:bg-blue-200/20'>
